    ...
    if (error) {
        return (
            <div className="p-8 text-center">
                <div className="w-16 h-16 bg-red-50 rounded-md flex items-center justify-center text-red-500 mx-auto mb-4">
                    <SearchX size={32} />
                </div>
    ...
    return (
        <div className="space-y-10 animate-in fade-in duration-700 pb-20">
            ...
            <div className="flex flex-col xl:flex-row xl:items-end justify-between gap-8">
                <div>
                    <h1 className="text-3xl font-black text-neutral-900 tracking-tighter uppercase leading-none">Salon <span className="text-primary">Network</span></h1>
                ...
                <div className="flex flex-col md:flex-row items-center gap-4">
                    ...
                    <Button
                        ...
                        className="w-full md:w-auto h-12 px-6 bg-neutral-900 hover:bg-primary text-white rounded-md font-black uppercase tracking-widest text-[10px] transition-all shadow-lg shadow-neutral-900/10 flex items-center justify-center gap-2"
                    >
                        <Plus size={16} />
                        Onboard Partner
                    </Button>
                                        ...
                                        <tr key={safeId} className="hover:bg-neutral-50/50 transition-colors group">
                                            <td className="px-6 py-5">
                                                <div className="flex items-center gap-4">
                                                    <div className="w-10 h-10 rounded-md bg-neutral-100 flex items-center justify-center text-neutral-400 font-bold text-xs uppercase group-hover:bg-primary group-hover:text-white transition-all">
